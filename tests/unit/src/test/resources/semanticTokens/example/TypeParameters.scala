...
<<class>>/*keyword*/ <<TypeParameters>>/*class*/[<<A>>/*typeParameter,abstract*/] {
  <<def>>/*keyword*/ <<method>>/*method*/[<<B>>/*typeParameter,abstract*/] <<=>>/*operator*/ <<42>>/*number*/
  ...
  <<type>>/*keyword*/ <<TypeAlias>>/*type*/[<<E>>/*typeParameter,abstract*/] <<=>>/*operator*/ <<List>>/*type*/[<<E>>/*typeParameter,abstract*/]
}