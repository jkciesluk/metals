...
<<case>>/*keyword*/ <<class>>/*keyword*/ <<MacroAnnotation>>/*class*/(
    <<name>>/*variable,readonly*/<<:>>/*operator*/ <<String>>/*type*/
) {
  <<def>>/*keyword*/ <<method>>/*method*/ <<=>>/*operator*/ <<42>>/*number*/
}
...
<<object>>/*keyword*/ <<MacroAnnotations>>/*class*/ {
  ...
  <<val>>/*keyword*/ <<x>>/*variable,readonly*/<<:>>/*operator*/ <<Defn>>/*class*/.<<Class>>/*interface,abstract*/ <<=>>/*operator*/ <<Defn>>/*class*/.<<Class>>/*class*/(
  ...
  <<val>>/*keyword*/ <<y>>/*variable,readonly*/<<:>>/*operator*/ <<Mod>>/*class*/.<<Final>>/*interface,abstract*/ <<=>>/*operator*/ <<Mod>>/*class*/.<<Final>>/*class*/()
}