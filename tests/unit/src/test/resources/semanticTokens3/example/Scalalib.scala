...
<<class>>/*keyword*/ <<Scalalib>>/*class*/ {
  <<val>>/*keyword*/ <<nil>>/*variable,readonly*/ <<=>>/*operator*/ <<List>>/*variable,readonly*/()
  <<val>>/*keyword*/ <<lst>>/*variable,readonly*/ <<=>>/*operator*/ <<List>>/*variable,readonly*/[
    (
